...
import com.cloud.bluewhale.clients.InteractClient;
import com.cloud.bluewhale.clients.VideoClient;
import com.cloud.bluewhale.constant.UserConstant;
import com.cloud.bluewhale.exception.ErrorParamException;
import com.cloud.bluewhale.exception.UserNotExitedException;
import com.cloud.bluewhale.exception.UserNotLoginException;
import com.cloud.bluewhale.mapper.UserMapper;
...
public class UserInfoServiceImpl implements UserInfoService {
    ...
    public ResponseResult<String> uploadUserImage(MultipartFile imageFile) {
        ...
        String url = null;
        try {
            url = ossUtil.upload(name, imageFile.getInputStream());
        } catch (Exception e) {
